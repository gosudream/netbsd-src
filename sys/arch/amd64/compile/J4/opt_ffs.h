/* option `UFS_EXTATTR_AUTOSTART' not defined */
#ifdef _LOCORE
 .ifndef _KERNEL_OPT_UFS_EXTATTR_AUTOSTART
 .global _KERNEL_OPT_UFS_EXTATTR_AUTOSTART
 .equiv _KERNEL_OPT_UFS_EXTATTR_AUTOSTART,0x6e074def
 .endif
#else
__asm(" .ifndef _KERNEL_OPT_UFS_EXTATTR_AUTOSTART\n .global _KERNEL_OPT_UFS_EXTATTR_AUTOSTART\n .equiv _KERNEL_OPT_UFS_EXTATTR_AUTOSTART,0x6e074def\n .endif");
#endif
